				  ...
				  unsigned long len, unsigned long pgoff, unsigned long flags)
{
	...
	/* mm parameter dropped in v6.19 (commit 9ac09bb9feacc) */
 ...
 *
 * If the kernel carries PGTY_mali_gpu (0xf9) in include/linux/page-flags.h and
 * the matching case in mm/migrate.c:set_movable_ops(), we translate the old API
 ...
 *
 * If PGTY_mali_gpu is NOT defined (unpatched kernel), page migration support is
 * disabled — __SetPageMovable/__ClearPageMovable become no-ops and
 * KBASE_PAGE_MIGRATION_SUPPORTED is not set.
 */
...
#define __SetPageMovable(page, ops) do { } while (0)
#define __ClearPageMovable(page) do { } while (0)
#endif /* PGTY_mali_gpu */
#endif /* KERNEL_VERSION >= 6.17 */
